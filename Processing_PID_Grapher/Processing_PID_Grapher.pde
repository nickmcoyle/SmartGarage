...
int yBorder = 50;  // Size of the background area around the plot in screen pixels
int xBorder = 50;
...
void setup () {
  ...
  smooth();
  //  println(PFont.list());
  titleFont = createFont(fontType, 24);
  labelFont = createFont(fontType, 18 );
