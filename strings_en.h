...
"  var inputPassword = document.getElementById('p');"
...
"<form action='/usewithoutwifi' method='get'><button class='warning' onclick='return confirm('Use device without WiFi connection? PID will still work and you can turn it on using the button on the front panel.')'>Use Without WiFi</button></form><br/>\n", // use without wifi
"<hr><br/>" // MENU_SEP
};

//const char HTTP_PORTAL_OPTIONS[]   PROGMEM = strcat(HTTP_PORTAL_MENU[0] , HTTP_PORTAL_MENU[3] , HTTP_PORTAL_MENU[7], HTTP_PORTAL_MENU[8]);
...
".warning{background-color: #ec1f1f;}"
...
const char HTTP_HELP[]             PROGMEM =
 ...
 "<td><a href='/usewithoutwifi'>/usewithoutwifi</a></td>"
...
const char R_usewithoutwifi[]     PROGMEM = "/usewithoutwifi";
